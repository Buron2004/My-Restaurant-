...
import { MealTableSkeleton } from '../components/MealTableSkeleton'
...
export default function AdminMealsPage() {
  ...
  return <div className="admin-meals min-h-screen bg-[#FBF6EC] text-stone-900"><header className="border-b border-stone-200 bg-[#fbf8f2]"><div className="mx-auto flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between max-w-7xl px-5 py-5 lg:px-8"><div><p className="eyebrow">Operations / Menu</p><h1 className="mt-1 text-3xl font-semibold tracking-tight">Meal management</h1></div><div className="flex items-center gap-3"><AdminNav /><button className="button-primary" onClick={openCreate}>+ New meal</button></div></div></header><main className="admin-meals-main mx-auto max-w-7xl space-y-6 px-5 py-8 lg:px-8">
